...
if (MVGlobalVariables.defaultFoiURL.indexOf("https:") > -1) resp =  resp.replace(/http:/g,'https:').replace(/:80\/mapviewer/g,'/mapviewer');
...
if (MVGlobalVariables.defaultFoiURL.indexOf("https:") > -1) this.responseText = this.responseText.replace(/http:/g,'https:').replace(/:80\/mapviewer/g,'/mapviewer');
...
try{if (MVGlobalVariables.defaultFoiURL.indexOf("https:") > -1) resp = resp.replace(/http:/g,'https:').replace(/:80\/mapviewer/g,'/mapviewer');
eval("var result="+resp);
finalresult=result;
if(result.length==0){result=null;
return;
