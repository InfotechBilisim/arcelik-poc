...
public class DataAdresCadde {
    
    
    public DataAdresCadde() {
        super();
    }
    ...
    private long caddeId;
    private long caddeUavt;
    ...
    public void setCaddeId(long caddeId) {
        this.caddeId = caddeId;
    }

    public long getCaddeId() {
        return caddeId;
    }

    public void setCaddeUavt(long caddeUavt) {
        this.caddeUavt = caddeUavt;
    }

    public long getCaddeUavt() {
        return caddeUavt;
    }
    ...
    public String toJson() {
        ...
        s += "  \"mahalleAdi\": \"" + mahalleAdi + "\",\n";
        s += "  \"caddeId\": " + caddeId + ",\n";
        s += "  \"caddeAdresKodu\": " +caddeUavt + ",\n";
        s += "  \"caddeAdi\": \"" + Utils.convStrIfNull(caddeAdi) + "\"\n";
        s += "  }";
    ...
    public String toXml() {
        ...
        s += "    <caddeid>" +caddeId+ "</caddeid>\n";
        s += "    <caddeadreskodu>" + caddeUavt + "</caddeadreskodu>\n";
        s += "    <caddeAdi>" + Utils.convStrIfNull(caddeAdi)  + "</caddeAdi>\n";
