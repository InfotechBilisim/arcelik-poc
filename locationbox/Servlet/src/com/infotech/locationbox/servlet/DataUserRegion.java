...
public class DataUserRegion {
    ...
    protected JGeometry geo = null;


    public DataUserRegion() {
    }

    //-----------------------------------------------------------------------------

    public static DataUserRegion getInstance(ResultSet rset, boolean withCoors) {
        DataUserRegion dur = new DataUserRegion();
        try {
            dur.id = rset.getString("REGION_ID");
            dur.name = rset.getString("REGION_NAME");
            dur.type = rset.getInt("TYP");
            dur.string_1 = rset.getString("STRING_1");
            dur.string_2 = rset.getString("STRING_2");
            dur.string_3 = rset.getString("STRING_3");
            dur.string_4 = rset.getString("STRING_4");
            dur.string_5 = rset.getString("STRING_5");
            dur.string_6 = rset.getString("STRING_6");
            dur.string_7 = rset.getString("STRING_7");
            dur.string_8 = rset.getString("STRING_8");
            dur.string_9 = rset.getString("STRING_9");
            dur.number_1 = rset.getDouble("NUMBER_1");
            dur.number_2 = rset.getDouble("NUMBER_2");
            dur.number_3 = rset.getDouble("NUMBER_3");
            dur.number_4 = rset.getDouble("NUMBER_4");
            dur.number_5 = rset.getDouble("NUMBER_5");
            dur.number_6 = rset.getDouble("NUMBER_6");
            dur.number_7 = rset.getDouble("NUMBER_7");
            dur.number_8 = rset.getDouble("NUMBER_8");
            dur.number_9 = rset.getDouble("NUMBER_9");
            dur.latitude = rset.getDouble("YCOOR");
            dur.longitude = rset.getDouble("XCOOR");
            STRUCT obj = DbConn.convToSTRUCT(rset.getObject("GEOMBR"));
            if( obj != null ) dur.extent = Utils.getExtent(obj);
            else dur.extent = null;
            if (withCoors) {
                obj = DbConn.convToSTRUCT(rset.getObject("GEOLOC"));
                JGeometry geo = JGeometry.load(obj);
                dur.geo = geo;
                dur.oarray = geo.getOrdinatesArray();
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        }
